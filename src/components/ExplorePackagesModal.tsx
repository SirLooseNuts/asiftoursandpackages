...
interface ExplorePackagesModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function ExplorePackagesModal({ open, onOpenChange }: ExplorePackagesModalProps) {
  return (
      ...
      <DialogContent className="max-w-5xl max-h-[85vh] overflow-y-auto p-6 md:p-10">
        <DialogHeader className="border-b border-border/60 pb-6">
          ...
          <DialogDescription className="mt-2 text-sm text-muted-foreground">
            Explore the states and cities we travel to. Every place has its own image.
          </DialogDescription>
        </DialogHeader>
